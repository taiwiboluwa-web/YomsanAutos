...
const lexusWhite = 'https://hips.hearstapps.com/autoweek/assets/s3fs-public/2016_lexus_rx_350_005_3cab3fa335162c2335af48894b52728ee7698eeb.jpg';
const lexusBlack = 'https://img2.carmax.com/assets/28815986/hero.jpg?height=600&width=800';
const lexusBlue = 'https://content.homenetiol.com/2000292/2189540/0x0/stock_images/8/cc_2017LES120001_640/cc_2017LES120001_640_8X5.jpg';
...
export const vehicles: Vehicle[] = [
  ...
  { id: 5, brand: 'Honda', model: 'Accord 2.0T Sport', year: 2021, type: 'Sedan', status: 'Available', price: 38500, mileage: 32000, engine: '2.0L Turbo 4-Cylinder', hp: 252, hero: accordSport, gallery: [accordSport], colors: colors('Platinum White','Crystal Black','Sonic Grey','San Marino Red'), wheels: ['19” Sport Alloy'], interiors: ['Black Sport Cloth / Leather'], specifications: { 'Engine': '2.0L turbocharged 4-cylinder', 'Power': '252 horsepower', 'Transmission': '10-speed automatic' } },
  { id: 6, brand: 'Toyota', model: 'RAV4', year: 2022, type: 'SUV', status: 'Available', price: 42000, mileage: 28000, engine: '2.5L 4-Cylinder', hp: 203, hero: rav4Red, gallery: [rav4Red, rav4White, rav4Black], colors: [{ name: 'Red', value: '#b51e2b', image: rav4Red }, { name: 'Black', value: '#111111', image: rav4Black }, { name: 'White', value: '#f3f3ef', image: rav4White }], wheels: ['19” Alloy'], interiors: ['Black SofTex'] },
  { id: 7, brand: 'Hyundai', model: 'Sonata', year: 2022, type: 'Sedan', status: 'Available', price: 33000, mileage: 24000, engine: '2.5L 4-Cylinder', hp: 191, hero: sonataBlue, gallery: [sonataBlue], colors: [{ name: 'Blue', value: '#183f70', image: sonataBlue }], wheels: ['18” Alloy'], interiors: ['Black'] },
  { id: 8, brand: 'Toyota', model: 'Tacoma', year: 2022, type: 'Pickup', status: 'Available', price: 48500, mileage: 31000, engine: '3.5L V6', hp: 278, hero: tacomaBlue, gallery: [tacomaBlue, tacomaBlack], colors: [{ name: 'White', value: '#f3f3ef' }, { name: 'Orange', value: '#e36a27' }, { name: 'Black', value: '#111111', image: tacomaBlack }, { name: 'Blue', value: '#263e91', image: tacomaBlue }], wheels: ['16” Alloy','17” TRD Alloy'], interiors: ['Black Fabric','Black SofTex'] },
  { id: 9, brand: 'Lexus', model: 'RX 350 Sport', year: 2017, type: 'SUV', status: 'Available', price: 36500, mileage: 48000, engine: '3.5L V6', hp: 295, hero: lexusWhite, gallery: [lexusWhite, lexusBlack, lexusBlue], colors: [{ name: 'White', value: '#f3f3ef', image: lexusWhite }, { name: 'Black', value: '#111111', image: lexusBlack }, { name: 'Wine', value: '#7a1f2b' }, { name: 'Blue', value: '#183f70', image: lexusBlue }], wheels: ['19” Sport Alloy'], interiors: ['Black Leather','Parchment Leather'] },
  { id: 10, brand: 'Hyundai', model: 'Sonata', year: 2021, type: 'Sedan', status: 'Available', price: 29500, mileage: 39000, engine: '2.5L 4-Cylinder', hp: 191, hero: sonataGrey, gallery: [sonataGrey], colors: [{ name: 'Grey', value: '#777777', image: sonataGrey }], wheels: ['18” Alloy'], interiors: ['Black'] },
  { id: 11, brand: 'Hyundai', model: 'Santa Fe', year: 2022, type: 'SUV', status: 'Available', price: 41000, mileage: 27000, engine: '2.5L 4-Cylinder', hp: 191, hero: santaFeWhite, gallery: [santaFeWhite], colors: colors('White','Black','Grey'), wheels: ['19” Alloy'], interiors: ['Black Leather'] },
