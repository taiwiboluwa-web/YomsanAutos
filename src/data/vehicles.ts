...
// YOMSAN's supplied imagery remains the primary local showroom source.
const yomsanLocal = '/src/imports/yomsan_auto__2_-1.png';
const yomsanLocalAlt = '/src/imports/yomsan_auto__3_-1.png';

export const vehicles: Vehicle[] = [
  {
    id: 1,
    brand: 'BMW', model: 'M5 Competition', year: 2023, type: 'Sedan', status: 'Available',
    price: 115000, mileage: 8200, engine: '4.4L V8 Biturbo', hp: 625,
    hero: yomsanLocal,
    gallery: [yomsanLocal, yomsanLocalAlt, 'https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=1800&q=85'],
    colors: [
      { name: 'Obsidian Black', value: '#0b0d0f' },
      { name: 'Alpine White', value: '#f0f0ec' },
      { name: 'Marina Bay Blue', value: '#254b78' },
      { name: 'Brooklyn Grey', value: '#777b7e' },
    ],
    wheels: ['19” M Sport', '20” M Performance'], interiors: ['Black Merino Leather', 'Silverstone / Black']
  },
  {
    id: 2,
    brand: 'Porsche', model: 'Cayenne GTS', year: 2022, type: 'SUV', status: 'Available',
    price: 98000, mileage: 14500, engine: '4.0L V8 Twin-Turbo', hp: 453,
    hero: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=2000&q=88',
    gallery: [
  ...
  {
    id: 3,
    brand: 'Mercedes-AMG', model: 'GT 63 S', year: 2023, type: 'Coupe', status: 'Reserved',
    price: 158000, mileage: 3100, engine: '4.0L V8 Biturbo', hp: 630,
    hero: 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&w=2000&q=88',
    gallery: ['https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&w=2000&q=88', yomsanLocalAlt],
  ...
  {
    id: 4,
    brand: 'Mercedes-AMG', model: 'G 63', year: 2023, type: 'SUV', status: 'Available',
    price: 185000, mileage: 3400, engine: '4.0L V8 Biturbo', hp: 577,
    hero: 'https://images.unsplash.com/photo-1520031441872-265e4ff70366?auto=format&fit=crop&w=2000&q=88',
    gallery: ['https://images.unsplash.com/photo-1520031441872-265e4ff70366?auto=format&fit=crop&w=2000&q=88', yomsanLocal],
